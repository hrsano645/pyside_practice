...
class LayoutExample(QWidget):
    ...
    def __init__(self):
        ...
        # Create the build button with its caption
        self.cancell_button = QPushButton("&amp;Cancell", self)

        self.cancell_button.setFlat(True)

        # Connect its clicked signal to our slot
        self.cancell_button.clicked.connect(self.clicked_slot)

        # Add it to the button box
        self.button_box.addWidget(self.cancell_button)
